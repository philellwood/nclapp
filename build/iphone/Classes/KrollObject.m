 ...
 * Copyright (c) 2009-2011 by NclApp, Inc. All Rights Reserved.
...
//@interface NclAppObject : NSObject
//@end

@interface NclAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[NclAppObject class]])
		{
			for (NSString *key in [[(NclAppObject*)o modules] allKeys])
			{
