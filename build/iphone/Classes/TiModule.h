...
/**
 The base class for all NclApp modules
 */
...
/**
 NclApp Platform calls this method on startup.
 */
-(void)startup;

/**
 NclApp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 NclApp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 NclApp Platform calls this method on resume.
 @param sender The sender of the event.
 */
