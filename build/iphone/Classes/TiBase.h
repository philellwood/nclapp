...
// in simulator we redefine to format for NclApp Developer console
...
{\
	NSString * exceptionName = [@"org.nclapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.nclapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UINclAppNativeItemNone = -1, 
	UINclAppNativeItemSpinner = -2,
	UINclAppNativeItemProgressBar = -3,
	
	UINclAppNativeItemSlider = -4,
	UINclAppNativeItemSwitch = -5,
	UINclAppNativeItemMultiButton = -6,
	UINclAppNativeItemSegmented = -7,
	
	UINclAppNativeItemTextView = -8,
	UINclAppNativeItemTextField = -9,
	UINclAppNativeItemSearchBar = -10,
	
	UINclAppNativeItemPicker = -11,
	UINclAppNativeItemDatePicker = -12,
	
	UINclAppNativeItemInfoLight = -13,
	UINclAppNativeItemInfoDark = -14,
	
	UINclAppNativeItemDisclosure = -15,
	
	UINclAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all NclApp instances of
